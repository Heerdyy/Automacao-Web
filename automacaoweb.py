...
upd_navegador = Service(ChromeDriverManager().install()) # várivael que será instânciada e fará uma checkagem da versão do webdriver do chrome para a utilização e retornará o path do arquivo para o driver caso esteja em uma versão desatualizada
